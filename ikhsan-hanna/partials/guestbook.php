    ...
    <form action="#myform2" method="post" onSubmit="return confirm('Kirimkan pesan ini?');" id="myForm2">
        ...
        <div data-aos="fade-up">
            <table align="center" style="font-family:minion;" width="60%">
                ...
                <tr>
                    <td>
                        <textarea placeholder="Pesan & doa untuk Ikhsan & Hanna" class="w3-small fo1" name="ucapan" style="font-family:minion; border:1; border-radius:5px; width:100%; border-color:white;" rows="3"></textarea>
                    </td>
                </tr>
                <tr>
                    <td align="center">
