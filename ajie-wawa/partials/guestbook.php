<div class="bg4">
    ...
    <div class="w3-medium" style="background:url(material/box3.png); background-size:100%; background-repeat: no-repeat;" align="center" width="100%" id="rsvp">
        <div style="height: 500px;"></div>
        <div data-aos="flip-left"
            data-aos-easing="ease-out-cubic"
            data-aos-duration="2000">
            <img src="material/prayerwishes.png" style="width: 50%;">
        </div>
        <br>
        <form action="#myform2" method="post" onSubmit="return confirm('Kirimkan pesan ini?');" id="myForm2">
            ...
            <div data-aos="fade-up">
                <table align="center" style="font-family:minion;" width="60%">
                    ...
                    <tr>
                        <td>
                            <textarea placeholder="Pesan & doa untuk Ajie & Wawa" class="w3-small fo5" name="ucapan" style="font-family:minion; border:1; border-radius:5px; width:100%;" rows="3"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
