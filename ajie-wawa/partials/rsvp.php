...
?>
<div class="bg4">
    <table class="w3-medium" style="background:url(material/box2.png); background-size:100%; background-repeat: no-repeat;" align="center" width="100%" id="rsvp">
        <tr>
            <td align="center">
                <div style="height: 140px;"></div>
                <div data-aos="fade-up"
                    data-aos-anchor-placement="top-bottom">
                    <img src="material/rsvp.png" style="width: 50%;">
                </div>
