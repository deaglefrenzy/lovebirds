...
<body class="fo3 bg1">
    ...
    <div id="websiteContent">
        ...
        <div id="invitation-content" class="fo5 bg1">
            <img src="material/flower1.png" style="width: 100%;">
            <div style="height: 50px;"></div>
            <img src="material/logo1.png" style="width: 25%;">
            <div class="w3-small minioni" style="margin-top: 10px;">
                Segala sesuatu Kami ciptakan berpasang-pasangan<br>agar kamu mengingat (kebesaran Allah).
                <br><br>
                Adz-Dzariyat Ayat 49
            </div>
            <div style="height: 50px;"></div>
            <img src="material/flower2.png" style="width: 100%;">
            <div style="height: 50px;"></div>
