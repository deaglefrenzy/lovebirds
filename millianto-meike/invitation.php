...
<head>
    ...
    <meta property="og:image" itemprop="image" content="https://lovebirdsgallery.com/<?php echo $folder; ?>/material/thumbnail.png" />
...
if ($action == "rsvp") {
    ...
    $pihak = $_POST['pihak'];
    if (!empty($nama)) {
        $qu = "INSERT INTO " . $folder . "2 SET nama='$nama', guest='$guest', whatsapp='$whatsapp', pihak='$pihak'";
        //$qu = "INSERT INTO " . $folder2 . "2 SET nama='$nama', guest='$guest', pihak='$pihak'";
        //$qu = "INSERT INTO " . $folder2 . "2 SET nama='$nama', guest='$guest'";
        mysqli_query($conn, $qu) or die("gagal");
...
<table class="w3-medium" style="margin-bottom:-130px; margin-top:-100px; background:url(material/Millianto%20Web%20material-28.png); background-size:100%; background-repeat: no-repeat; font-family:bodoni;" align="center" width="100%" id="rsvp">
    <tr>
        <td align="center">
            ...
            <div style="height: 30px;"></div>
            <div data-aos="fade-up">
                <form action="invitation.php#rsvp" method="post" onsubmit="return confirm('Kirim RSVP?');">
                    <div style="line-height:38px;">
                        ...
                        <select class="w3-small" style="width:50%; border-radius:10px; height:30px; border-color:gold;" name="guest">
                            ...
                            <option value="1" <?php if ($gu == 1) echo "selected"; ?>>1 orang hadir</option>
                            <option value="2" <?php if ($gu == 2) echo "selected";
                                                if ($gu < 2) echo "disabled"; ?>>2 orang hadir</option>
                            <option value="3" <?php if ($gu == 3) echo "selected";
                                                if ($gu < 3) echo "disabled"; ?>>3 orang hadir</option>
                            <option value="4" <?php if ($gu == 4) echo "selected";
                                                if ($gu < 4) echo "disabled"; ?>>4 orang hadir</option>
                        </select>
...
<form action="invitation.php#gb" method="post" onSubmit="return confirm('Kirimkan pesan ini?');">
    ...
    <div data-aos="fade-up">
        <table align="center" style="font-family:minion;" width="60%">
            ...
            <tr>
                <td>
                    <textarea placeholder="Doa & ucapan untuk William & Febi" class="w3-small" name="ucapan" style="font-family:minion; border:1; border-radius:5px; width:100%; border-color:gold;" rows="3"></textarea>
                </td>
            </tr>
            <tr>
                <td align="center">
